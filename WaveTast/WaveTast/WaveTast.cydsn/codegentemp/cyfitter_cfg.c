...
#define BS_UDB_0_5_1_CONFIG_VAL ((const uint8 CYFAR *)0x00080540u)

/* IOPINS0_2 Address: CYREG_PRT2_DR Size (bytes): 10 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x000805C0u)

/* IOPINS0_4 Address: CYREG_PRT4_DM0 Size (bytes): 8 */
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x000805CCu)

/* IOPINS0_6 Address: CYREG_PRT6_DM0 Size (bytes): 8 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x000805D4u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_REG8((void CYXDATA *)CYREG_PRT6_AMUX, 0x40u);
